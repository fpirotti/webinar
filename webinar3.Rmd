...
- For this Webinar we use  R and RStudio IDE `r icon::fa_r_project(colour = "#384CB7") ` - if you want to follow along, make sure you have have installed R + RStudio in your PC   
...
myarea<-st_point(data.gee$features[[1]]$geometry$coordinates)
...
feature1.2017.lm2 <- lm( feature1.2017$VH_p50  ~ feature1.2017$shadow_p50 )
...
A function is an object that 'does things' taking input arguments - inside parenthesis - and returns a value (object).
