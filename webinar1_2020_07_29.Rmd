...
```{r}
mapview( grid.points.myproj[1:20,] ) + mapview( nodes.buffered[1:20,] )  + mapview( tiles[1:20,] )
```
...
```{java}
// IMPORTS 
// these are in the "import" top part of the script editor in GEE, but can also be added to the script itself.
var srtm = ee.Image("CGIAR/SRTM90_V4"),
    srtm_viz = {"opacity":1,"bands":["elevation"],"min":1439.9060309998727,"max":2892.700269813135,"palette":["005aff","ff0000"]},
    geometry = /* color: #d63000 */ee.Geometry.MultiPoint(),
    tiles = ee.FeatureCollection("users/2020_Kanan/summer_webinar_series/Webinar1_tiles");
