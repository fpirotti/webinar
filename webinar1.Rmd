...
- For this Webinar we use  *R* programming environment  `r icon::fa_r_project(colour = "#384CB7") ` and *RStudio* as graphical development interface - if you want to follow along, make sure you have have installed R + RStudio in your PC!  

- You will find the data [here](data/webinar1/).
...
- You can find the data [here](data/webinar1/) or directly in the GitHUB directory [check link here](#code-copyleft)
